...
@Component({
    standalone: true,
    imports: [AppDoc],
    template: ` <app-doc title="Custom Icons - Optimus UI" header="Custom Icons" description="Optimus UI components can be used with any icon library using the templating features." [docs]="docs" docType="page"></app-doc>`
})
