        ...
        <div>
            ...
            <div class="card mb-7">
                ...
                <p class="m-0 leading-normal mb-7 text-secondary text-surface-800 dark:text-surface-50">
                    ...
                    <a [routerLink]="['/support']" class="text-primary font-medium hover:underline">{{ PROJECT_NAME }} PRO.</a>
                </p>
                    ...
                    <table class="doc-table">
                        ...
                        <tbody>
                            <tr class="text-surface-800 dark:text-surface-50">
                                ...
                                <td class="p-2"><a href="{{ GITHUB_REPO_URL }}/blob/master/CHANGELOG.md" target="_blank" rel="noopener noreferrer">Changelog</a></td>
                            </tr>
                            <tr class="text-surface-800 dark:text-surface-50">
                                <td class="p-2">
                                ...
                                <td class="p-2"><a href="{{ GITHUB_REPO_URL }}/blob/master/changelog-lts/v19-LTS.md" target="_blank" rel="noopener noreferrer">Changelog</a></td>
                            </tr>
                            <tr class="text-surface-800 dark:text-surface-50">
                                <td class="p-2">
                                ...
                                <td class="p-2">After v21 release</td>
                                <td class="p-2"><a href="{{ GITHUB_REPO_URL }}/blob/master/changelog-lts/v18-LTS.md" target="_blank" rel="noopener noreferrer">Changelog</a></td>
                            </tr>
                ...
                <div class="flex flex-col md:flex-row gap-7">
                    <div class="flex-1">
                        ...
                        <p class="m-0 leading-normal mb-4 text-secondary text-surface-800 dark:text-surface-50">
                            {{ PROJECT_NAME }} comes with a commitment to provide long-term support, including regular security updates to keep your system protected against emerging threats.
                        </p>
                    </div>
                    <div class="flex-1">
                        <div class="flex items-center mb-2">
            ...
            <div class="card m-0">
                ...
                <div class="flex flex-wrap -ml-7 -mt-7">
                    <div class="w-full lg:w-4/12 p-7">
                        <div class="text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">Do I have to purchase a license for {{ PROJECT_NAME }}?</div>
                        ...
                        <div class="text-surface-900 dark:text-surface-0 leading-normal mb-2 font-medium">Is LTS License mandatory to use {{ PROJECT_NAME }}?</div>
                    ...
                    <div class="w-full lg:w-4/12 p-7">
                        ...
                        <p class="mt-0 p-0 leading-normal text-surface-800 dark:text-surface-50">No, {{ PROJECT_NAME }} PRO is the service where response of PrimeTek engineers is secured within 1 business day.</p>
                    </div>
                    <div class="w-full lg:w-4/12 p-7">
