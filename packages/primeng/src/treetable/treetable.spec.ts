...
describe('TreeTable', () => {
    ...
    describe('Public Methods', () => {
        ...
        it('should reset scroll position', async () => {
            vi.spyOn(treetable, 'resetScrollTop');
        ...
        it('should reset component state', async () => {
            treetable.first = 10;
            treetable._sortField = 'name';
            treetable._sortOrder = -1;
    ...
    describe('Pagination', () => {
        ...
        it('should handle page change event', async () => {
            vi.spyOn(treetable.onPage, 'emit');
        ...
        it('should handle lazy loading on page change', async () => {
            ...
            vi.spyOn(treetable.onLazyLoad, 'emit');
    ...
    describe('Sorting', () => {
        ...
        it('should emit onSort event', async () => {
            vi.spyOn(treetable.onSort, 'emit');
    ...
    describe('Selection', () => {
        ...
        it('should handle single selection', async () => {
            ...
            vi.spyOn(treetable.selectionChange, 'emit');
        ...
        it('should handle context menu selection', async () => {
            vi.spyOn(treetable.contextMenuSelectionChange, 'emit');
            vi.spyOn(treetable.onContextMenuSelect, 'emit');
    ...
    describe('Node Expansion/Collapse', () => {
        ...
        it('should emit node expand event', async () => {
            vi.spyOn(treetable.onNodeExpand, 'emit');
        ...
        it('should emit node collapse event', async () => {
            vi.spyOn(treetable.onNodeCollapse, 'emit');
    ...
    describe('Filtering', () => {
        ...
        it('should emit filter event', async () => {
            vi.spyOn(treetable.onFilter, 'emit');
    ...
    describe('Lazy Loading', () => {
        ...
        it('should not emit lazy load on initialization when lazyLoadOnInit is false', async () => {
            ...
            vi.spyOn(newTreetable.onLazyLoad, 'emit');
    ...
    describe('Input Properties Tests', () => {
        ...
        describe('Additional Input Properties', () => {
            ...
            it('should handle all number transform properties', async () => {
                ...
                for (const { prop, value } of signalNumberProps) {
                ...
                // 'first' is a mutable field, not a signal
                component.first = 10;
                fixture.changeDetectorRef.markForCheck();
                await fixture.whenStable();
                fixture.detectChanges();
    ...
    describe('Dynamic and Observable Input Value Tests', () => {
        ...
        describe('Comprehensive Dynamic Property Tests', () => {
            it('should handle dynamic boolean property updates with observables', async () => {
                if (dynamicTreetable) {
                    // Test a representative set of boolean signal properties via wrapper
                    const booleanProperties = ['autoLayout', 'loading', 'scrollable', 'virtualScroll', 'showGridlines'];

                    for (const prop of booleanProperties) {
                        (dynamicComponent as any)[prop] = true;
                        dynamicFixture.changeDetectorRef.markForCheck();
                        await dynamicFixture.whenStable();
                        dynamicFixture.detectChanges();
                        await dynamicFixture.whenStable();
                        ...
                        (dynamicComponent as any)[prop] = false;
                        dynamicFixture.changeDetectorRef.markForCheck();
                        await dynamicFixture.whenStable();
                        dynamicFixture.detectChanges();
                        await dynamicFixture.whenStable();
            ...
            it('should handle dynamic number property updates with observables', async () => {
                if (dynamicTreetable) {
                    ...
                    // Test filterDelay
                    for (const delay of [100, 300, 500, 1000]) {
                    ...
                    for (const delay of [50, 100, 150, 300]) {
            ...
            it('should handle dynamic string property updates with observables', async () => {
                if (dynamicTreetable) {
                    ...
                    for (const tableClass of ['table-class', 'responsive-table', '']) {
                    ...
                    // Test sortMode
                    for (const mode of ['single', 'multiple'] as ('single' | 'multiple')[]) {
...
describe('TreeTable PT', () => {
    ...
    describe('Case 10: PT Hooks', () => {
        it.skip('should execute onAfterViewInit hook', async () => {
