...
describe('AutoFocus', () => {
    ...
    describe('Focusable Elements Detection', () => {
        it('should focus first focusable element when multiple elements exist', async () => {
            ...
            vi.spyOn(firstInput, 'focus').mockImplementation(() => {});
            vi.spyOn(secondInput, 'focus').mockImplementation(() => {});
        ...
        it('should focus container element when no focusable children exist', async () => {
            ...
            vi.spyOn(containerElement, 'focus').mockImplementation(() => {});
        ...
        it('should find nested focusable elements', async () => {
            ...
            vi.spyOn(nestedInput, 'focus').mockImplementation(() => {});
            vi.spyOn(nestedSelect, 'focus').mockImplementation(() => {});
            vi.spyOn(nestedTextarea, 'focus').mockImplementation(() => {});
    ...
    describe('Multiple Directive Instances', () => {
        it('should handle multiple autofocus directives independently', async () => {
            ...
            vi.spyOn(input1, 'focus').mockImplementation(() => {});
            vi.spyOn(input2, 'focus').mockImplementation(() => {});
            ...
            // Reset spies
            (input1.focus as Mock).mockClear();
            (input2.focus as Mock).mockClear();
    ...
    describe('Integration with DomHandler', () => {
        it('should use DomHandler.getFocusableElements to find focusable elements', async () => {
            ...
            vi.spyOn(mockFocusableElements[0], 'focus').mockImplementation(() => {});
            await fixture.whenStable();
            await new Promise((resolve) => setTimeout(resolve, 10));
