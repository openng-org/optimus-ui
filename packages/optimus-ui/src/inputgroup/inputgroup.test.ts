...
describe('InputGroup', () => {
    ...
    describe('Multiple Addons', () => {
        ...
        it('should apply a custom class to InputGroup alongside the base class', () => {
            const inputGroupElement = fixture.debugElement.query(By.directive(InputGroup));
        ...
        it('should update the custom class dynamically', async () => {
            ...
            expect(inputGroupElement.nativeElement.classList.contains('custom-input-group')).toBe(false);
        });
    });
...
describe('InputGroup PassThrough Tests', () => {
    ...
    describe('PT Case 4: Instance variables', () => {
        ...
        it('should read instance state in PT function', () => {
            fixture.componentRef.setInput('pt', {
                root: ({ instance }: any) => ({
                    class: instance?.componentName === 'InputGroup' ? 'WITH_NAME' : 'NO_NAME'
                })
            });
            fixture.detectChanges();
