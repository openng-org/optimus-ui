...
describe('AnimateOnScroll', () => {
    ...
    describe('Enter Animation', () => {
        ...
        it('should not trigger enter animation if already in enter state', async () => {
            ...
            vi.spyOn(directiveEl.nativeElement.classList, 'add').mockImplementation(() => {});
    ...
    describe('Once Behavior', () => {
        ...
        it('should not unbind observer when once is false', async () => {
            ...
            vi.spyOn(directive, 'unbindIntersectionObserver').mockImplementation(() => {});
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle undefined enterClass and leaveClass', async () => {
            ...
            await expect(fixture.whenStable()).resolves.toSatisfy(() => true);
        });
