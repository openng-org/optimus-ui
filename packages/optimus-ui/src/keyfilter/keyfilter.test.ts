...
describe('KeyFilter', () => {
    ...
    describe('Input Event Handling', () => {
        ...
        it('should reject invalid input on Android', async () => {
            ...
            vi.spyOn(directive.ngModelChange, 'emit').mockImplementation(() => {});
    ...
    describe('Keypress Event Handling', () => {
        ...
        it('should allow ctrl+key combinations', () => {
            ...
            vi.spyOn(ctrlAEvent, 'preventDefault').mockImplementation(() => {});
    ...
    describe('Paste Event Handling', () => {
        ...
        it('should allow valid pasted content', () => {
            ...
            vi.spyOn(pasteEvent, 'preventDefault').mockImplementation(() => {});
        ...
        it('should prevent invalid content with complex regex', async () => {
            ...
            const mockClipboardData = {
                getData: vi.fn(() => '1234') // too many digits
            };
    ...
    describe('Event Integration Tests', () => {
        it('should integrate all events correctly', async () => {
            ...
            vi.spyOn(validKeyEvent, 'preventDefault').mockImplementation(() => {});
            ...
            vi.spyOn(invalidKeyEvent, 'preventDefault').mockImplementation(() => {});
            ...
            vi.spyOn(validPasteEvent, 'preventDefault').mockImplementation(() => {});
    ...
    describe('Model Change Events', () => {
        it('should emit ngModelChange on Android input correction', async () => {
            directive.isAndroid = true;
            vi.spyOn(testComponent, 'onModelChange').mockImplementation(() => {});
            vi.spyOn(directive.ngModelChange, 'emit').mockImplementation(() => {});
