...
describe('Knob', () => {
    ...
    describe('Basic Functionality Tests', () => {
        ...
        it('should handle click interaction', () => {
            vi.spyOn(knobInstance, 'updateValue').mockImplementation(() => {});
            const svgElement = fixture.debugElement.query(By.css('svg'));
        ...
        it('should emit onChange event', async () => {
            vi.spyOn(knobInstance.onChange, 'emit').mockImplementation(() => {});
    ...
    describe('Keyboard Navigation Tests', () => {
        ...
        it('should increase value with ArrowUp/ArrowRight', async () => {
            ...
            vi.spyOn(upEvent, 'preventDefault').mockImplementation(() => {});
            ...
            vi.spyOn(rightEvent, 'preventDefault').mockImplementation(() => {});
        ...
        it('should decrease value with ArrowDown/ArrowLeft', async () => {
            ...
            vi.spyOn(downEvent, 'preventDefault').mockImplementation(() => {});
            ...
            vi.spyOn(leftEvent, 'preventDefault').mockImplementation(() => {});
        ...
        it('should handle PageUp and PageDown keys', async () => {
            ...
            vi.spyOn(pageUpEvent, 'preventDefault').mockImplementation(() => {});
            ...
            vi.spyOn(pageDownEvent, 'preventDefault').mockImplementation(() => {});
    ...
    describe('Mouse Interaction Tests', () => {
        ...
        it('should handle mousedown event', () => {
            ...
            vi.spyOn(mouseDownEvent, 'preventDefault').mockImplementation(() => {});
        ...
        it('should handle mouseup event', () => {
            ...
            vi.spyOn(mouseUpEvent, 'preventDefault').mockImplementation(() => {});
    ...
    describe('Touch Interaction Tests', () => {
        ...
        it('should handle touchstart event', () => {
            ...
            vi.spyOn(touchStartEvent, 'preventDefault').mockImplementation(() => {});
        ...
        it('should handle touchend event', () => {
            ...
            vi.spyOn(touchEndEvent, 'preventDefault').mockImplementation(() => {});
