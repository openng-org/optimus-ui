...
import { CascadeSelectBeforeHideEvent, CascadeSelectBeforeShowEvent, CascadeSelectChangeEvent, CascadeSelectHideEvent, CascadeSelectShowEvent } from '@openng/optimus-ui/types/cascadeselect';
 ...
 */
describe('CascadeSelect loading icon', () => {
    let fixture: ComponentFixture<TestCascadeSelectLoadingIconComponent>;
    let component: TestCascadeSelectLoadingIconComponent;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [CascadeSelect],
            declarations: [TestCascadeSelectLoadingIconComponent],
            providers: [provideZonelessChangeDetection()]
        }).compileComponents();

        fixture = TestBed.createComponent(TestCascadeSelectLoadingIconComponent);
        component = fixture.componentInstance;
        fixture.detectChanges();
    });

    it('should render the svg spinner when no loadingIcon is supplied', () => {
        const spinner = fixture.debugElement.query(By.css('svg[data-p-icon="spinner"].p-cascadeselect-loading-icon'));
        ...
        expect(fixture.debugElement.query(By.css('.p-cascadeselect-loading-icon.pi-spin'))).toBeNull();
    });
    ...
    it('should keep the spin class and the custom classes separate for a custom loadingIcon', () => {
        ...
        const icon = fixture.debugElement.query(By.css('.p-cascadeselect-loading-icon'));
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `<p-cascadeselect [options]="countries" optionLabel="cname" optionGroupLabel="name" [optionGroupChildren]="['cities']" [loading]="true" [loadingIcon]="loadingIcon()"></p-cascadeselect>`
})
class TestCascadeSelectLoadingIconComponent {
    countries = [{ name: 'Australia', cities: [{ cname: 'Sydney' }] }];
