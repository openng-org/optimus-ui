...
import { AngleRightIcon, ChevronDownIcon, SpinnerIcon, TimesIcon } from '@openng/optimus-ui/icons';
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, Overlay, AutoFocus, CascadeSelectSub, ChevronDownIcon, SpinnerIcon, TimesIcon, SharedModule, Bind],
    template: `
        ...
        <div [class]="cx('dropdown')" role="button" aria-haspopup="listbox" [attr.aria-expanded]="overlayVisible ?? false" [pBind]="ptm('dropdown')" [attr.aria-hidden]="true">
            <ng-container *ngIf="loading; else elseBlock">
                ...
                <ng-container *ngIf="!loadingIconTemplate && !_loadingIconTemplate">
                    <span *ngIf="loadingIcon" [class]="cxLoadingIcon(loadingIcon)" [attr.aria-hidden]="true" [pBind]="ptm('loadingIcon')"></span>
                    <svg data-p-icon="spinner" *ngIf="!loadingIcon" [class]="cx('loadingIcon')" [spin]="true" [attr.aria-hidden]="true" [pBind]="ptm('loadingIcon')" />
                </ng-container>
            </ng-container>
