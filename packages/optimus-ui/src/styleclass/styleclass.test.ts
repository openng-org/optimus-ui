...
describe('StyleClass', () => {
    ...
    describe('Click Handler Tests', () => {
        it('should handle click event', async () => {
            vi.spyOn(styleClassInstance, 'toggle').mockImplementation(() => {});
            component.toggleClass = 'active';
            fixture.changeDetectorRef.markForCheck();
            await fixture.whenStable();
        ...
        it('should call enter method when target is hidden', async () => {
            vi.spyOn(styleClassInstance, 'enter').mockImplementation(() => {});
        ...
        it('should call leave method when target is visible', async () => {
            vi.spyOn(styleClassInstance, 'leave').mockImplementation(() => {});
    ...
    describe('Enter Method Tests', () => {
        ...
        it('should bind listeners when hideOnOutsideClick is true', async () => {
            ...
            vi.spyOn(styleClassInstance, 'bindDocumentClickListener').mockImplementation(() => {});
        ...
        it('should bind listeners when hideOnEscape is true', async () => {
            ...
            vi.spyOn(styleClassInstance, 'bindDocumentKeydownListener').mockImplementation(() => {});
        ...
        it('should bind listeners when hideOnResize is true', async () => {
            ...
            vi.spyOn(styleClassInstance, 'bindResizeListener').mockImplementation(() => {});
    ...
    describe('Leave Method Tests', () => {
        ...
        it('should unbind listeners when hideOnOutsideClick is true', async () => {
            ...
            vi.spyOn(styleClassInstance, 'unbindDocumentClickListener').mockImplementation(() => {});
        ...
        it('should unbind listeners when hideOnEscape is true', async () => {
            ...
            vi.spyOn(styleClassInstance, 'unbindDocumentKeydownListener').mockImplementation(() => {});
        ...
        it('should unbind listeners when hideOnResize is true', async () => {
            ...
            vi.spyOn(styleClassInstance, 'unbindResizeListener').mockImplementation(() => {});
    ...
    describe('Resize Tests', () => {
        ...
        it('should handle unbind resize listener', () => {
            ...
            vi.spyOn(resizeInstance, 'unbindElementResizeListener').mockImplementation(() => {});
            vi.spyOn(resizeInstance, 'unbindWindowResizeListener').mockImplementation(() => {});
