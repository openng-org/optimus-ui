...
@Component({
    selector: 'p-image',
    standalone: true,
    imports: [RefreshIcon, EyeIcon, UndoIcon, SearchMinusIcon, SearchPlusIcon, TimesIcon, FocusTrap, SharedModule, BindModule, MotionModule, NgIf, NgStyle, NgTemplateOutlet],
    template: `
