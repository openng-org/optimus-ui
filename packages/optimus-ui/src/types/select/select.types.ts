...
import type { PassThrough, PassThroughOption, ScrollerOptions } from '@openng/optimus-ui/api';
...
import type { OverlayPassThrough } from '@openng/optimus-ui/types/overlay';
