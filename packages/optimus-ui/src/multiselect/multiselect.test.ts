...
describe('MultiSelect', () => {
    ...
    describe('Event Handling', () => {
        ...
        it('should emit onFilter event when filtering', async () => {
            vi.spyOn(component, 'onFilter').mockImplementation(() => {});
        ...
        it('should emit onClick event', () => {
            vi.spyOn(component, 'onClick').mockImplementation(() => {});
        ...
        it('should emit onClear event', () => {
            vi.spyOn(component, 'onClear').mockImplementation(() => {});
        ...
        it('should emit onSelectAllChange event', () => {
            vi.spyOn(component, 'onSelectAllChange').mockImplementation(() => {});
        ...
        it('should remove option when chip is clicked', async () => {
            ...
            vi.spyOn(component, 'onRemove').mockImplementation(() => {});
    ...
    describe('Keyboard Navigation', () => {
        ...
        it('should handle arrow down key', async () => {
            ...
            vi.spyOn(keyEvent, 'stopPropagation').mockImplementation(() => {});
...
describe('MultiSelect Templates', () => {
    ...
    it('should handle chip removal through template', () => {
        ...
        vi.spyOn(multiSelect, 'removeOption').mockImplementation(() => {});
...
describe('MultiSelect Virtual Scrolling', () => {
    ...
    it('should handle lazy loading', async () => {
        ...
        vi.spyOn(component, 'onLazyLoad').mockImplementation(() => {});
 ...
 */
describe('MultiSelect loading icon', () => {
    let fixture: ComponentFixture<TestMultiSelectLoadingIconComponent>;
    let component: TestMultiSelectLoadingIconComponent;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [MultiSelect],
            declarations: [TestMultiSelectLoadingIconComponent],
            providers: [provideZonelessChangeDetection()]
        }).compileComponents();

        fixture = TestBed.createComponent(TestMultiSelectLoadingIconComponent);
        component = fixture.componentInstance;
        fixture.detectChanges();
    });

    it('should render the svg spinner when no loadingIcon is supplied', () => {
        const spinner = fixture.debugElement.query(By.css('svg[data-p-icon="spinner"].p-multiselect-loading-icon'));
        ...
        expect(fixture.debugElement.query(By.css('.p-multiselect-loading-icon.pi-spin'))).toBeNull();
    });
    ...
    it('should keep the spin class and the custom classes separate for a custom loadingIcon', () => {
        ...
        const icon = fixture.debugElement.query(By.css('.p-multiselect-loading-icon'));
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `<p-multiselect [options]="options" optionLabel="name" [loading]="true" [loadingIcon]="loadingIcon()"></p-multiselect>`
})
class TestMultiSelectLoadingIconComponent {
