...
const classes = {
    ...
    label: ({ instance }) => ({
        ...
        'p-placeholder': instance.label() === instance._placeholder(),
        'p-multiselect-label-empty': !instance._placeholder() && !instance.defaultLabel && (!instance.modelValue() || instance.modelValue().length === 0)
    }),
