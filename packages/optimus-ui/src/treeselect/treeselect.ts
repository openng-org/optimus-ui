...
import { OverlayOptions, PrimeTemplate, ScrollerOptions, SharedModule, TreeNode } from '@openng/optimus-ui/api';
...
import { ChevronDownIcon, TimesIcon } from '@openng/optimus-ui/icons';
import { Overlay } from '@openng/optimus-ui/overlay';
import { Tree, TreeFilterEvent, TreeNodeSelectEvent, TreeNodeUnSelectEvent } from '@openng/optimus-ui/tree';
...
@Component({
    ...
    standalone: true,
    imports: [Overlay, SharedModule, Tree, AutoFocus, TimesIcon, ChevronDownIcon, Chip, Bind, NgFor, NgIf, NgStyle, NgTemplateOutlet],
    hostDirectives: [Bind],
    template: `
