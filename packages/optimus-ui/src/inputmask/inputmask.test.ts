...
describe('InputMask', () => {
    ...
    describe('Public Methods', () => {
        ...
        it('should clear input value', () => {
            (vi.spyOn(component, 'onModelChange') as Mock).mockImplementation(() => {});
    ...
    describe('Event Handling', () => {
        ...
        it('should handle focus event', async () => {
            vi.spyOn(testComponent, 'onInputFocus').mockImplementation(() => {});
            testFixture.detectChanges();
        ...
        it('should handle blur event', async () => {
            vi.spyOn(testComponent, 'onInputBlur').mockImplementation(() => {});
            testFixture.detectChanges();
        ...
        it('should handle input change event', () => {
            vi.spyOn(testComponent, 'onInputChange').mockImplementation(() => {});
            testFixture.detectChanges();
        ...
        it('should emit onComplete via the real onKeyPress handler when the mask is fully filled', () => {
            ...
            fixture.componentRef.setInput('mask', '9');
            (component as any).inputViewChild = () =>
                ({
                    nativeElement: {
                        value: '',
        ...
        it('should handle clear event when showClear is enabled', async () => {
            vi.spyOn(testComponent, 'onClearEvent').mockImplementation(() => {});
    ...
    describe('Keyboard Input Processing', () => {
        ...
        it('should process numeric input correctly', () => {
            vi.spyOn(component, 'caret').mockReturnValue({ begin: 0, end: 0 });
            vi.spyOn(component, 'updateModel').mockImplementation(() => {});
            vi.spyOn(component.onInput, 'emit').mockImplementation(() => {});
        ...
        it('should handle backspace correctly', () => {
            ...
            vi.spyOn(component, 'shiftL').mockImplementation(() => {});
        ...
        it('should handle escape key correctly', () => {
            ...
            vi.spyOn(component, 'caret').mockImplementation(() => {});
        ...
        it('should handle enter key correctly', () => {
            vi.spyOn(component, 'onInputBlur').mockImplementation(() => {});
            vi.spyOn(component, 'updateModel').mockImplementation(() => {});
        ...
        it('should ignore invalid characters', () => {
            vi.spyOn(component, 'caret').mockReturnValue({ begin: 0, end: 0 });
            vi.spyOn(component, 'updateModel').mockImplementation(() => {}); // Spy on updateModel to avoid null target error
...
describe('InputMaskDirective', () => {
    ...
    describe('Keyboard Handling', () => {
        it('should handle backspace key correctly', async () => {
            ...
            vi.spyOn(directive, 'shiftL').mockImplementation(() => {});
            vi.spyOn(directive, 'clearBuffer').mockImplementation(() => {});
