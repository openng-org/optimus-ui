...
describe('Breadcrumb', () => {
    ...
    describe('Component Initialization', () => {
        ...
        it('should have required dependencies injected', () => {
            ...
            expect(breadcrumbInstance).toBeInstanceOf(Breadcrumb);
        });
    ...
    describe('Navigation Tests', () => {
        ...
        it('should emit onItemClick event', () => {
            vi.spyOn(breadcrumbInstance.onItemClick, 'emit').mockImplementation(() => {});
        ...
        it('should prevent default for disabled items', () => {
            const clickEvent = new MouseEvent('click');
            vi.spyOn(clickEvent, 'preventDefault').mockImplementation(() => {});
