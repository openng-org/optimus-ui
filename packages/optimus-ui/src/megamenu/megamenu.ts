...
import { MegaMenuItem, PrimeTemplate, SharedModule } from '@openng/optimus-ui/api';
import { BadgeModule } from '@openng/optimus-ui/badge';
import { BaseComponent, PARENT_INSTANCE } from '@openng/optimus-ui/basecomponent';
import { Bind } from '@openng/optimus-ui/bind';
import { AngleDownIcon, AngleRightIcon, BarsIcon } from '@openng/optimus-ui/icons';
import { Ripple } from '@openng/optimus-ui/ripple';
import { TooltipModule } from '@openng/optimus-ui/tooltip';
import { VoidListener } from '@openng/optimus-ui/ts-helpers';
import { MegaMenuItemTemplateContext, MegaMenuPassThrough } from '@openng/optimus-ui/types/megamenu';
...
@Component({
    ...
    standalone: true,
    imports: [RouterModule, Ripple, TooltipModule, AngleDownIcon, AngleRightIcon, BadgeModule, SharedModule, Bind, NgFor, NgIf, NgStyle, NgTemplateOutlet],
    template: `
...
@Component({
    ...
    standalone: true,
    imports: [RouterModule, MegaMenuSub, TooltipModule, BarsIcon, BadgeModule, SharedModule, Bind, NgIf, NgTemplateOutlet],
    template: `
