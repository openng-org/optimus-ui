...
@Component({
    ...
    standalone: false,
    template: ` <p-tag [value]="value" [icon]="icon" [severity]="severity" [rounded]="rounded" [class]="styleClass"> </p-tag> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <p-tag [value]="value" [severity]="severity" [style]="style" [class]="styleClass"> </p-tag> `
})
...
describe('Tag', () => {
    ...
    describe('Component Initialization', () => {
        ...
        it('should accept custom values', async () => {
            ...
            expect(tagElement.nativeElement.classList.contains('custom-class')).toBe(true);
        });
        ...
        it('should initialize template queries', () => {
    ...
    describe('Input Properties', () => {
        ...
        it('should apply a custom class on the host', async () => {
            component.styleClass = 'test-class';
            fixture.changeDetectorRef.markForCheck();
            await fixture.whenStable();
            fixture.detectChanges();
            expect(tagElement.nativeElement.classList.contains('test-class')).toBe(true);
        });
    ...
    describe('Icon Template Tests', () => {
        it('should handle #icon template processing', async () => {
            ...
            expect(iconTemplateTag.$iconTemplate()).toBe(iconTemplateTag.iconTemplate());
        ...
        it('should handle pTemplate icon processing', async () => {
            ...
            expect(pTemplateTag.templates().length).toBe(1);
        ...
        it('should prioritize the #icon content child over pTemplate="icon"', async () => {
            ...
            // Both templates are present; the #icon content child wins
            expect(multipleTag.iconTemplate()).toBeDefined();
            expect(multipleTag.templates().length).toBe(1);
            expect(multipleTag.$iconTemplate()).toBe(multipleTag.iconTemplate());
        });
    ...
    describe('CSS Classes and Styling', () => {
        it('should apply a custom class to the root element via class binding', async () => {
    ...
    describe('Template Processing Tests', () => {
        it('should resolve a pTemplate="icon" through $iconTemplate', async () => {
            const pTemplateFixture = TestBed.createComponent(TestPTemplateTagComponent);
            pTemplateFixture.detectChanges();
            await new Promise((resolve) => setTimeout(resolve, 100));
            await pTemplateFixture.whenStable();
            ...
            expect(pTemplateTag.iconTemplate()).toBeUndefined();
            expect(pTemplateTag.$iconTemplate()).toBeDefined();
        });

        it('should have no effective icon template without icon content', () => {
            expect(tagInstance.$iconTemplate()).toBeUndefined();
        });
        ...
        it('should handle templates without icon type', async () => {
            ...
            expect(basicTag.templates().length).toBe(0);
    ...
    describe('Integration Tests', () => {
        ...
        it('should work with styled component', () => {
            ...
            expect(styleFixture.debugElement.query(By.directive(Tag)).nativeElement.classList.contains('custom-tag-class')).toBe(true);
        });
    ...
    describe('Derived State', () => {
        it('should expose the effective icon template as a computed', async () => {
            const pTemplateFixture = TestBed.createComponent(TestPTemplateTagComponent);
            pTemplateFixture.detectChanges();
            await new Promise((resolve) => setTimeout(resolve, 100));
            await pTemplateFixture.whenStable();
        ...
        it('should compute data-p from rounded and severity', async () => {
            component.severity = 'success';
            component.rounded = true;
            fixture.changeDetectorRef.markForCheck();
            await fixture.whenStable();
            ...
            expect(tagElement.nativeElement.getAttribute('data-p')).toContain('rounded');
        });
    });
