...
describe('TreeTable', () => {
    ...
    describe('Public Methods', () => {
        ...
        it('should reset scroll position', async () => {
            vi.spyOn(treetable, 'resetScrollTop').mockImplementation(() => {});
    ...
    describe('Pagination', () => {
        ...
        it('should handle page change event', async () => {
            vi.spyOn(treetable.onPage, 'emit').mockImplementation(() => {});
        ...
        it('should handle lazy loading on page change', async () => {
            ...
            vi.spyOn(treetable.onLazyLoad, 'emit').mockImplementation(() => {});
    ...
    describe('Sorting', () => {
        ...
        it('should emit onSort event', async () => {
            vi.spyOn(treetable.onSort, 'emit').mockImplementation(() => {});
    ...
    describe('Selection', () => {
        ...
        it('should handle single selection', async () => {
            ...
            vi.spyOn(treetable.selectionChange, 'emit').mockImplementation(() => {});
    ...
    describe('Filtering', () => {
        ...
        it('should emit filter event', async () => {
            vi.spyOn(treetable.onFilter, 'emit').mockImplementation(() => {});
    ...
    describe('Lazy Loading', () => {
        ...
        it('should not emit lazy load on initialization when lazyLoadOnInit is false', async () => {
            ...
            vi.spyOn(newTreetable.onLazyLoad, 'emit').mockImplementation(() => {});
                ...
                if (dynamicTreetable) {
                    ...
                    for (const data of validEdgeCases) {
                        try {
                            ...
                            expect.fail(`Should not throw for valid edge case: ${JSON.stringify(data)}`);
                        }
                    }
