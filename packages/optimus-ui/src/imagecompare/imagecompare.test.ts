...
describe('ImageCompare', () => {
    ...
    describe('RTL Support', () => {
        ...
        it('should setup mutation observer for direction changes', () => {
            vi.spyOn(imageCompareInstance, 'updateDirection').mockImplementation(() => {});
    ...
    describe('Component Lifecycle', () => {
        ...
        it('should initialize direction detection on ngOnInit', () => {
            vi.spyOn(imageCompareInstance, 'updateDirection').mockImplementation(() => {});
            vi.spyOn(imageCompareInstance, 'observeDirectionChanges').mockImplementation(() => {});
        ...
        it('should call super.ngOnDestroy', () => {
            vi.spyOn(Object.getPrototypeOf(Object.getPrototypeOf(imageCompareInstance)), 'ngOnDestroy').mockImplementation(() => {});
    ...
    describe('Public Methods', () => {
        ...
        afterEach(() => {
            // Restore the real MutationObserver so it doesn't leak into later tests/files
        ...
        it('should observeDirectionChanges method setup mutation observer correctly', () => {
            // Must be a real function (not an arrow function) so it is constructible via `new MutationObserver(...)`,
            // matching how the karma/jasmine twin uses `jasmine.createSpy(...).and.returnValue(...)` (constructible).
