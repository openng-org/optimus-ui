...
describe('SpeedDial', () => {
    ...
    describe('Event Handling', () => {
        ...
        it('should emit onVisibleChange and visibleChange events', async () => {
            const visibleChangeSpy = vi.spyOn(component, 'onVisibleChange').mockImplementation(() => {});
            const visibleChangeV2Spy = vi.spyOn(component, 'onVisibleChangeV2').mockImplementation(() => {});
        ...
        it('should emit onShow event when shown', async () => {
            const showSpy = vi.spyOn(component, 'onShow').mockImplementation(() => {});
        ...
        it('should emit onHide event when hidden', async () => {
            const hideSpy = vi.spyOn(component, 'onHide').mockImplementation(() => {});
