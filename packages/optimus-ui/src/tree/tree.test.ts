...
describe('Tree', () => {
    ...
    describe('Context Menu Selection', () => {
        ...
        it('should emit onNodeContextMenuSelect event on right click', async () => {
            vi.spyOn(tree.onNodeContextMenuSelect, 'emit').mockImplementation(() => {});
...
describe('Tree inside a parent form', () => {
    beforeEach(async () => {
        await TestBed.configureTestingModule({
    ...
    it('should not register its internal ngModel with the parent form', async () => {
        const warnSpy = vi.spyOn(console, 'warn').mockImplementation(() => {});
        const isolationFixture = TestBed.createComponent(TestFormIsolationTreeComponent);
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: true,
    imports: [Tree, ReactiveFormsModule],
    template: `
        <form [formGroup]="form">
            <p-tree [value]="nodes" selectionMode="checkbox" />
        </form>
...
class TestFormIsolationTreeComponent {
