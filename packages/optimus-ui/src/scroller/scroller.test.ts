...
describe('Scroller', () => {
    ...
    describe('Event Handling Tests', () => {
        ...
        it('should emit onScroll event', async () => {
            vi.spyOn(component, 'onScroll').mockImplementation(() => {});
            vi.spyOn(scroller, 'onScrollChange').mockImplementation(() => {}); // Mock to prevent null access
        ...
        it('should emit onScrollIndexChange event', async () => {
            vi.spyOn(component, 'onScrollIndexChange').mockImplementation(() => {});
    ...
    describe('Edge Cases and Error Scenarios', () => {
        ...
        it('should handle window resize gracefully', async () => {
            vi.spyOn(scroller, 'init').mockImplementation(() => {});
        ...
        it('should clean up resources on destroy', async () => {
            vi.spyOn(scroller, 'unbindResizeListener').mockImplementation(() => {});
