...
describe('DataView', () => {
    ...
    describe('Event Handling', () => {
        it('should emit onLazyLoad on init when lazy and lazyLoadOnInit are true', async () => {
            ...
            vi.spyOn(lazyComponent, 'onLazyLoadEvent').mockImplementation(() => {});
        ...
        it('should emit onPage event when paginating', async () => {
            ...
            vi.spyOn(component, 'onPageEvent').mockImplementation(() => {});
        ...
        it('should emit onSort event when sorting', async () => {
            ...
            vi.spyOn(component, 'onSortEvent').mockImplementation(() => {});
        ...
        it('should emit onChangeLayout event when layout changes', async () => {
            vi.spyOn(component, 'onChangeLayoutEvent').mockImplementation(() => {});
        ...
        it('should emit onLazyLoad when paginating in lazy mode', async () => {
            ...
            vi.spyOn(component, 'onLazyLoadEvent').mockImplementation(() => {});
    ...
    describe('Lifecycle and Cleanup', () => {
        it('should unsubscribe from translation observer on destroy', () => {
            ...
            vi.spyOn(translationSub!, 'unsubscribe').mockImplementation(() => {});
        ...
        it('should call ngAfterViewInit', () => {
            vi.spyOn(dataview, 'ngAfterViewInit').mockImplementation(() => {});
        ...
        it('should trigger lazy load correctly when initialized', async () => {
            ...
            vi.spyOn(lazyDataview.onLazyLoad, 'emit').mockImplementation(() => {});
