...
describe('FileUpload', () => {
    ...
    describe('Upload Process', () => {
        ...
        it('should upload files via HTTP', async () => {
            ...
            vi.spyOn(component.onUpload, 'emit').mockImplementation(() => {});
    ...
    describe('Template Context Callback Testing', () => {
        ...
        it('should execute chooseCallback from template context', () => {
            if (fileUploadComponent) {
                vi.spyOn(fileUploadComponent, 'choose').mockImplementation(() => {});
        ...
        it('should execute clearCallback from template context', () => {
            if (fileUploadComponent) {
                vi.spyOn(fileUploadComponent, 'clear').mockImplementation(() => {});
        ...
        it('should execute uploadCallback from template context', () => {
            if (fileUploadComponent) {
                vi.spyOn(fileUploadComponent, 'upload').mockImplementation(() => {});
