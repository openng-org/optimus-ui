...
describe('Panel', () => {
    ...
    describe('Keyboard Navigation', () => {
        it('should toggle on Enter key', async () => {
            ...
            vi.spyOn(panelInstance, 'toggle').mockImplementation(() => {});
    ...
    describe('Tab Index Management', () => {
        it('should call updateTabIndex when collapsed state changes', () => {
            ...
            vi.spyOn(panelComp, 'updateTabIndex').mockImplementation(() => {});
    ...
    describe('Public Methods', () => {
        ...
        it('should call updateTabIndex when expanding', () => {
            vi.spyOn(panelInstance, 'updateTabIndex').mockImplementation(() => {});
            panelInstance.expand();
