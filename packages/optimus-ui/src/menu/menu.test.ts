...
describe('Menu', () => {
    ...
    describe('Keyboard Navigation Tests', () => {
        ...
        it('should handle arrow down key', () => {
            vi.spyOn(menuInstance, 'onArrowDownKey').mockImplementation(() => {});
        ...
        it('should handle arrow up key', () => {
            vi.spyOn(menuInstance, 'onArrowUpKey').mockImplementation(() => {});
        ...
        it('should handle home key', () => {
            vi.spyOn(menuInstance, 'onHomeKey').mockImplementation(() => {});
        ...
        it('should handle end key', () => {
            vi.spyOn(menuInstance, 'onEndKey').mockImplementation(() => {});
        ...
        it('should handle enter key', () => {
            vi.spyOn(menuInstance, 'onEnterKey').mockImplementation(() => {});
        ...
        it('should handle space key', () => {
            vi.spyOn(menuInstance, 'onSpaceKey').mockImplementation(() => {});
        ...
        it('should handle escape key for popup menu', async () => {
            ...
            vi.spyOn(menuInstance, 'hide').mockImplementation(() => {});
    ...
    describe('Focus Management Tests', () => {
        it('should emit onFocus when list gains focus', () => {
            vi.spyOn(menuInstance.onFocus, 'emit').mockImplementation(() => {});
    ...
    describe('Popup Menu Tests', () => {
        it('should show and hide popup menu', async () => {
            ...
            vi.spyOn(menuInstance.onShow, 'emit').mockImplementation(() => {});
            vi.spyOn(menuInstance.onHide, 'emit').mockImplementation(() => {});
        ...
        it('should handle overlay click', async () => {
            ...
            vi.spyOn(overlayService, 'add').mockImplementation(() => {});
        ...
        it('should bind document click listener for popup', async () => {
            ...
            vi.spyOn(menuInstance, 'bindDocumentClickListener').mockImplementation(() => {});
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle memory cleanup on destroy', () => {
            vi.spyOn(menuInstance, 'unbindDocumentClickListener').mockImplementation(() => {});
    ...
    describe('PassThrough (PT)', () => {
        ...
        describe('Case 7: Test from OptimusConfig', () => {
            ...
            it('should apply global PT configuration from Optimus config', () => {
