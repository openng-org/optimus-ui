...
describe('Toast', () => {
    ...
    describe('Template Content Projection - Headless approach', () => {
        ...
        it('should handle close callback in headless template', async () => {
            ...
            const toastEl = fixture.debugElement.query(By.css('p-toast'));
            const toastInstance = toastEl.componentInstance as Toast;
            vi.spyOn(toastInstance, 'onMessageClose').mockImplementation(() => {});
    ...
    describe('CSS Classes and Styling', () => {
        ...
        it('should apply custom class via native class binding', async () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: ` <p-toast [key]="'class-test'" [class]="customClass"></p-toast> `
            })
            class TestToastClassComponent {
                customClass = 'custom-toast-class';
            }

            await TestBed.resetTestingModule();
            await TestBed.configureTestingModule({
                imports: [Toast],
                declarations: [TestToastClassComponent],
                providers: [MessageService, provideZonelessChangeDetection()]
            }).compileComponents();

            const classFixture = TestBed.createComponent(TestToastClassComponent);
            classFixture.detectChanges();

            const toastEl = classFixture.debugElement.query(By.css('p-toast'));
    ...
    describe('Animation and Lifecycle', () => {
        ...
        it('should handle animation start events', () => {
            const toastEl = fixture.debugElement.query(By.css('p-toast'));
            const toastInstance = toastEl.componentInstance as Toast;
            vi.spyOn(toastInstance, 'onAnimationStart').mockImplementation(() => {});
        ...
        it('should handle animation end events', () => {
            const toastEl = fixture.debugElement.query(By.css('p-toast'));
            const toastInstance = toastEl.componentInstance as Toast;
            vi.spyOn(toastInstance, 'onAnimationEnd').mockImplementation(() => {});
    ...
    describe('Memory Management and Cleanup', () => {
        ...
        it('should unsubscribe from messageService on destroy', () => {
            ...
            vi.spyOn(toastInstance.messageSubscription!, 'unsubscribe').mockImplementation(() => {});
            vi.spyOn(toastInstance.clearSubscription!, 'unsubscribe').mockImplementation(() => {});
        ...
        it('should destroy custom styles on component destroy', async () => {
            ...
            vi.spyOn(toastInstance, 'destroyStyle').mockImplementation(() => {});
    ...
    describe('Toast PassThrough - Case 7: Test from OptimusConfig', () => {
        @Component({
            changeDetection: ChangeDetectionStrategy.Eager,
            standalone: false,
            template: `
