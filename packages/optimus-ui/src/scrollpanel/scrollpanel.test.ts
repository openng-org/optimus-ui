...
describe('ScrollPanel', () => {
    ...
    describe('Keyboard Navigation', () => {
        ...
        it('should handle arrow key navigation in vertical orientation', async () => {
            ...
            vi.spyOn(arrowDownEvent, 'preventDefault').mockImplementation(() => {});
            vi.spyOn(arrowUpEvent, 'preventDefault').mockImplementation(() => {});
        ...
        it('should handle arrow key navigation in horizontal orientation', async () => {
            ...
            vi.spyOn(arrowRightEvent, 'preventDefault').mockImplementation(() => {});
            vi.spyOn(arrowLeftEvent, 'preventDefault').mockImplementation(() => {});
    ...
    describe('Mouse Interactions', () => {
        ...
        it('should handle vertical bar mouse down', async () => {
            ...
            vi.spyOn(yBar.nativeElement, 'focus').mockImplementation(() => {});
            vi.spyOn(mouseEvent, 'preventDefault').mockImplementation(() => {});
        ...
        it('should handle horizontal bar mouse down', async () => {
            ...
            vi.spyOn(xBar.nativeElement, 'focus').mockImplementation(() => {});
            vi.spyOn(mouseEvent, 'preventDefault').mockImplementation(() => {});
    ...
    describe('Public Methods', () => {
        ...
        it('should refresh scrollbar position and size', async () => {
            vi.spyOn(scrollPanel, 'moveBar').mockImplementation(() => {});
    ...
    describe('Memory Management', () => {
        ...
        it('should cleanup listeners on destroy', async () => {
            ...
            vi.spyOn(scrollPanel, 'unbindListeners').mockImplementation(() => {});
