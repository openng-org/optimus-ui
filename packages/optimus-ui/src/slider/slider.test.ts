...
describe('Slider', () => {
    ...
    describe('Event Handling', () => {
        ...
        it('should emit onChange event for single slider', async () => {
            vi.spyOn(testComponent, 'onSliderChange').mockImplementation(() => {});
        ...
        it('should emit onSlideEnd event', async () => {
            vi.spyOn(testComponent, 'onSlideEnd').mockImplementation(() => {});
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle component destruction', () => {
            vi.spyOn(component, 'unbindDragListeners').mockImplementation(() => {});
    ...
    describe('Advanced Interaction Tests', () => {
        ...
        it('should handle bar click events', async () => {
            ...
            vi.spyOn(component, 'updateDomData').mockImplementation(() => {});
            vi.spyOn(component, 'handleChange').mockImplementation(() => {});
