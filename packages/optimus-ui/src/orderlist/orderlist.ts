...
@Component({
    ...
    standalone: true,
    imports: [ButtonModule, Ripple, DragDropModule, AngleDoubleDownIcon, AngleDoubleUpIcon, AngleUpIcon, AngleDownIcon, Listbox, FormsModule, SharedModule, Bind, NgIf, NgTemplateOutlet],
    template: `
