...
describe('SplitButton', () => {
    ...
    describe('Event Handling', () => {
        ...
        it('should emit onDropdownClick event when dropdown button is clicked', async () => {
            const dropdownClickSpy = vi.spyOn(component, 'onDropdownClick').mockImplementation(() => {});
        ...
        it('should emit onMenuShow event when menu is shown', async () => {
            const showSpy = vi.spyOn(component, 'onMenuShow').mockImplementation(() => {});
        ...
        it('should emit onMenuHide event when menu is hidden', async () => {
            const hideSpy = vi.spyOn(component, 'onMenuHide').mockImplementation(() => {});
    ...
    describe('Public Methods', () => {
        ...
        it('should call onClick.emit in onDefaultButtonClick', () => {
            const emitSpy = vi.spyOn(splitButtonInstance.onClick, 'emit').mockImplementation(() => {});
        ...
        it('should call onDropdownClick.emit in onDropdownButtonClick', () => {
            const emitSpy = vi.spyOn(splitButtonInstance.onDropdownClick, 'emit').mockImplementation(() => {});
            const mockEvent = new MouseEvent('click');
